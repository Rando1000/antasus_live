        ...
        <section class="relative py-24 overflow-hidden bg-white">
            ...
            <div class="relative max-w-4xl px-6 mx-auto text-center">
                <!-- <div class="flex justify-center mb-8">
                    <ApplicationLogo2 class="h-40" />
                </div> -->
                <h1
                    class="mb-6 text-4xl font-extrabold text-gray-900 md:text-5xl"
                >
                    <span class="text-teal-500">Professioneller</span>
                    Glasfaserausbau
                </h1>
                <p
                    class="max-w-3xl mx-auto mb-8 text-xl leading-relaxed text-gray-700"
                >
                    Normgerecht, terminsicher und partnerschaftlich –
                    <span class="font-semibold text-gray-900"
                        >Ihr zuverlässiger Partner</span
                    >
                ...
                <div class="flex flex-col justify-center gap-4 sm:flex-row">
                    <Link
                        href="/kontakt"
                        class="px-8 py-3 font-semibold text-white transition-all bg-gray-900 rounded-lg shadow-lg hover:bg-indigo-700 hover:shadow-xl"
                    >
                        Jetzt Kontakt aufnehmen
                    </Link>
                    <Link
                        href="/leistungen"
                        class="px-8 py-3 font-semibold text-gray-900 transition-colors bg-white border border-gray-300 rounded-lg hover:bg-gray-50"
                    >
                        Unsere Leistungen
                    </Link>
                </div>
            ...
            <div class="max-w-6xl px-6 mx-auto">
                <div class="mb-16 text-center">
                    <h2 class="mb-4 text-3xl font-bold text-gray-900">
                        Unsere <span class="text-teal-600">Leistungen</span>
                    </h2>
                    <p class="max-w-2xl mx-auto text-gray-600">
                        Komplettlösungen für Ihren Glasfaserausbau nach
                ...
                <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-2">
                    <div
                        ...
                        :key="index"
                        class="p-8 transition-all bg-white border border-gray-200 shadow-sm rounded-xl hover:shadow-md hover:border-indigo-200"
                    >
                        <div class="flex items-start">
                            <div
                                class="flex-shrink-0 p-3 mr-4 bg-indigo-100 rounded-full"
                            >
                                <span class="text-xl text-indigo-600">{{
                                    icons[index]
                                }}</span>
                            </div>
                            <div>
